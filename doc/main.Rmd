...
Movie_train_p[Movie_train_p!=0 & !is.na(Movie_train_p)] <- 3 + Movie_train_p[Movie_train_p!=0 & !is.na(Movie_train_p)]

simrank_Movie_neighbor_p = neighbors.select(as.matrix(simrank_Movie_p), N=20)
simrank_Movie_pred_p = predict.Movie(sim_weights = as.matrix(simrank_Movie_p), train = Movie_train_p, top.neighbors = simrank_Movie_neighbor_p)

simrank_Movie_neighbor_n = neighbors.select(as.matrix(simrank_Movie_n), N=20)
simrank_Movie_pred_n = predict.Movie(sim_weights = as.matrix(simrank_Movie_n), train = Movie_train_n, top.neighbors = simrank_Movie_neighbor_n)

simrank_Movie_pred_np <- (simrank_Movie_pred_n + simrank_Movie_pred_p)/2 
