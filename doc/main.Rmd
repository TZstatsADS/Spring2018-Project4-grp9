...
simrank_pred_p[simrank_pred_p!=0 & !is.na(simrank_pred_p)] <- simrank_pred_p[simrank_pred_p!=0 & !is.na(simrank_pred_p)] + 3
simrank_pred_n[simrank_pred_n!=0 & !is.na(simrank_pred_n)] <- 4 - simrank_pred_n[simrank_pred_n!=0 & !is.na(simrank_pred_n)]
sim_rank_pred_np <- simrank_pred_n + simrank_pred_p 
