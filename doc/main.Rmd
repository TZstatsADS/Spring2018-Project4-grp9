...
# With Intersection
# source("../lib/MeanSquare_movie_intersect.R")
# weight_MSD_Movie_intersect <- MSD_intersect(Movie_train)
# save(weight_MSD_Movie_intersect,
#      file = "../output/Similarity_Weight/weight_MSD_Movie_intersect.RData")
load("../output/Similarity_Weight/weight_MSD_Movie_intersect.RData")
```
...
# MSD(with intersection)
MSD_Movie_neighbor_intersect =  neighbors.select(weight_MSD_Movie_intersect, N=20)
MSD_Movie_pred_intersect = predict.Movie(sim_weights = weight_MSD_Movie_intersect,
                                   top.neighbors = MSD_Movie_neighbor_intersect)
...
# MSD + Var(with intersection)
MSD_var_Movie_intersect = var_weight_Movie * weight_MSD_Movie_intersect
MSD_var_Movie_neighbor_intersect =  neighbors.select(MSD_var_Movie_intersect, N=20)
MSD_var_Movie_pred_intersect = predict.Movie(sim_weights = MSD_var_Movie_intersect,
                                       top.neighbors = MSD_var_Movie_neighbor_intersect)
...
```{r,warning=FALSE}
# train
cluster_model <- MultmixEM(MS_train, navie=F,C=15)
...
save(cluster_model_pred, file="../output/cluster_model/cluster_model.R")
```
...
MSD_MAE_Movie_intersect <- MAE(MSD_Movie_pred_intersect, Movie_test)
MSD_var_MAE_Movie_intersect <- MAE(MSD_var_Movie_pred_intersect, Movie_test)

# simrank_MAE_Movie <- MAE(simrank_Movie_pred, Movie_test)
...
MSD_MAE_Movie
MSD_var_MAE_Movie
MSD_MAE_Movie_intersect
MSD_var_MAE_Movie_intersect
simrank_MAE_Movie
...
MSD_ROC_4_Movie_intersect <- ROC_4(MSD_Movie_pred_intersect, Movie_test)
MSD_var_ROC_4_Movie_intersect <- ROC_4(MSD_var_Movie_pred_intersect, Movie_test)
...
MSD_ROC_4_Movie
MSD_var_ROC_4_Movie
MSD_ROC_4_Movie_intersect
MSD_var_ROC_4_Movie_intersect
simrank_ROC_4_Movie
